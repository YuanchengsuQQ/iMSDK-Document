...
| 功能 | 支持平台 | 介绍 |
| -- | -- | -- |
| 登录 | [Android](Android/Module/Push.md), [iOS](iOS/Module/Push.md), [Unity](Unity/Module/Push.md) | 提供授权信息，为游戏登录提供支持 |
| 分享 | 统一接口调用三方SDK进行分享，如：分享微信朋友圈 |
| 好友 | 邀请好友，获取好友列表及向好友发送消息等功能 |
| 支付 | 集成米大师（Midas）海外支付功能 |
| 推送 | 提供信鸽等消息推送机制
...
2. 申请需要接入渠道平台
  ...
  开发者需要自行到需要接入的渠道平台申请开发者账号及应用信息，常见接入
